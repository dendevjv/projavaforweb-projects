package projava2webbook.discussion_board.config;
...
@EnableScheduling
@ComponentScan(
        basePackages = "projava2webbook.discussion_board.site",
...
public class RootContextConfiguration
    ...
    public Jaxb2Marshaller jaxb2Marshaller() {
        ...
        marshaller.setPackagesToScan(new String[] { "projava2webbook.discussion_board.site" });
        return marshaller;
    }
