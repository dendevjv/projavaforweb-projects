<%--@elvariable id="discussion" type="projava2webbook.discussion_board.site.entity.Discussion"--%>
<%--@elvariable id="replies" type="java.util.List<projava2webbook.discussion_board.site.entity.Reply>"--%>
