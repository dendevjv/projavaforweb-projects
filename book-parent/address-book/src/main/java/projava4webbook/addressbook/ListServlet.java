...
public class ListServlet extends HttpServlet {
    ...
    static {
        ...
        contacts.add(new Contact("John", "Smith", "555-0712", "315 Maple St", null,
                Instant.parse("2012-10-15T09:31:17Z")));
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.getRequestDispatcher("/WEB-INF/jsp/view/list-i18n.jsp").forward(req, resp);
    }
